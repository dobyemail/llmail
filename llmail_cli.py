#!/usr/bin/env python3
"""
llmail - AI-powered email management CLI
Komendy:
  llmail generate - Generuj testowe emaile (email_generator)
  llmail clean    - Organizuj i kategoryzuj emaile (email_organizer)
  llmail write    - Generuj odpowiedzi z AI (email_responder)
...
def main():
    """Główny entry point dla llmail CLI"""
    parser = argparse.ArgumentParser(
        prog='llmail',
        description='AI-powered email management toolkit',
        epilog='Użyj "llmail <komenda> --help" dla szczegółów każdej komendy'
    )
